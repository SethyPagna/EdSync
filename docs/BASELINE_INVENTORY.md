...
This inventory implements Phase 1 of `docs/planning/plan.md`. It maps the current routes, data model, capabilities, duplicate concepts, and verification baseline before the next architecture and feature work begins.
