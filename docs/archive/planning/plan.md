...
- Existing improvement plan: `docs/archive/superpowers/plans/2026-05-16-edsync-lessons-slides-platform.md`.
...
- `docs/archive/superpowers/plans/2026-05-16-edsync-lessons-slides-platform.md`: existing detailed implementation plan for the Studio lesson and slide slice.
