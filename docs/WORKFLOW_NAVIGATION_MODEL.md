...
This document implements Phase 2 of `plan.md`. It defines the canonical product flow, navigation handoffs, saved-state labels, and route responsibilities before the next architecture phases introduce shared learning objects and refactor the large editor/player files.
