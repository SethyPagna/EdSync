...
> = {
  micro: {
    ...
    aiInstruction: "Keep it fast, highly scannable, and ready for a short course starter or review.",
  },
  standard: {
    label: "Standard",
    slideCount: "6-9 slides",
    sectionDepth: "clear sections with examples, media notes, and creator checkpoints",
...
export const LESSON_TEMPLATE_PRESETS = [
  ...
  },
  {
    ...
    bestFor: ["manual authoring", "slide design", "rich documents", "creator-made courses"],
    designNotes: [
    ...
    reviewSignals: ["draft persistence", "layout clarity", "creator editability"],
  },
  {
    id: "exam-prep",
    label: "Exam Prep",
    ...
    bestFor: ["test preparation", "retrieval practice", "mastery review", "learner self-study"],
    designNotes: [
...
export const DESIGN_TEMPLATES: DesignTemplate[] = [
  ...
  },
  {
    ...
    description: "A visual opener with title, objective, and learner action.",
...
export function buildLessonDesignPromptContext(templateId: unknown, outputLength: unknown = DEFAULT_OUTPUT_LENGTH) {
  ...
  return {
    ...
    requiredOutput: {
      ...
      lesson: `editable sections with duration, media notes, creator review flags, and ${lengthPlan.sectionDepth}`,
