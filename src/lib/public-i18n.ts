...
export const publicCopy: Record<PublicLanguageName, PublicCopy> = {
  English: {
    ...
    heroTags: ["Catalog", "Studio", "AI", "Practice", "Grades"],
  ...
  Khmer: {
    ...
    heroTags: ["កាតាឡុក", "ស្ទូឌីយោ", "AI", "អនុវត្ត", "ពិន្ទុ"],
  ...
  Spanish: {
    ...
    heroTags: ["Catálogo", "Estudio", "AI", "Práctica", "Notas"],
  ...
  French: {
    ...
    heroTags: ["Catalogue", "Studio", "AI", "Pratique", "Notes"],
  ...
  Vietnamese: {
    ...
    heroTags: ["Danh mục", "Studio", "AI", "Luyện tập", "Điểm"],
  ...
  Thai: {
    ...
    heroTags: ["แคตตาล็อก", "สตูดิโอ", "AI", "ฝึก", "คะแนน"],
    searchHeading: "ค้นหา",
