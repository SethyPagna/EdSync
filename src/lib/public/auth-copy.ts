...
const englishAuthCopy: AuthCopy = {
  ...
  individualCopy: "Personal course buyer, learner, or creator workspace.",
  ...
  signupPanelCopy: "Start as an individual for online courses and personal creation, or enter an organization for managed classes.",
  spaceStep: "1 Workspace",
  ssoOptions: "SSO options",
  stillCheckingOrganization: "Still checking that organization.",
  student: "Student",
  studentCopy: "Buy or join courses, take lessons, track grades, and save personal progress.",
  teacher: "Teacher",
  teacherCopy: "Create courses, manage classes, grade work, and publish catalog items for individuals or organizations.",
  useIndividual: "Use as individual",
  welcomeBack: "Welcome back",
  workspaceTitle: "Enter your learning workspace.",
  workspaceCopy: "Choose an organization for managed access, or use Individual for personal learning, course purchases, and creator tools.",
