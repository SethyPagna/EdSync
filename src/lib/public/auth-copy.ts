...
const englishAuthCopy: AuthCopy = {
  ...
  createRightSpaceTitle: "Choose your EdSync space.",
  ...
  individualCopy: "Create or learn courses independently.",
  ...
  organizationBenefits: "Independent courses for individuals. Managed portals for organizations.",
  organizationCode: "Organization code",
  organizationCopy: "Owner portal with creator and learner workspaces.",
  organizationName: "Organization name",
  password: "Password",
  passwordMin: "Password must be at least 8 characters.",
  passwordPlaceholder: "Minimum 8 characters",
  protectedPortals: "Protected individual, organization, and owner views.",
  role: "Role",
  roleStep: "2 Role",
  signingIn: "Signing in...",
  signupPanelCopy: "Use EdSync independently, or enter an organization portal with scoped creator and learner modes.",
  spaceStep: "1 Workspace",
  ssoOptions: "SSO options",
  stillCheckingOrganization: "Still checking that organization.",
  student: "Learner",
  studentCopy: "Learn, practice, and track progress.",
  teacher: "Creator",
  teacherCopy: "Create, publish, and review courses.",
  useIndividual: "Individual",
  welcomeBack: "Welcome back",
  workspaceTitle: "Enter your EdSync workspace.",
  workspaceCopy: "Use individual access for independent courses, or organization access for managed creator and learner modes.",
