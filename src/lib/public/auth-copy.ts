...
const englishAuthCopy: AuthCopy = {
  ...
  organizationCopy: "Owner portal with teacher and student workspaces.",
  organizationName: "Organization name",
  password: "Password",
  passwordMin: "Password must be at least 8 characters.",
  passwordPlaceholder: "Minimum 8 characters",
  protectedPortals: "Protected owner, teacher, and student portals.",
  role: "Role",
  roleStep: "2 Role",
  signingIn: "Signing in...",
  signupPanelCopy: "Use EdSync independently, or enter an organization portal with teacher and student workspaces.",
  ...
  workspaceCopy: "Use individual access for independent courses, or organization access for managed teacher and student portals.",
