...
const englishAuthCopy: AuthCopy = {
  ...
  createRightSpaceTitle: "Choose your space.",
  ...
  organizationBenefits: "Individual + organization.",
  organizationCode: "Organization code",
  organizationCopy: "Owner, Creator, Learner.",
  organizationName: "Organization name",
  password: "Password",
  passwordMin: "Password must be at least 8 characters.",
  passwordPlaceholder: "Minimum 8 characters",
  protectedPortals: "Individual + organization.",
  role: "Role",
  roleStep: "2 Role",
  signingIn: "Signing in...",
  signupPanelCopy: "Create, learn, or manage a portal.",
  ...
  workspaceTitle: "Choose your space.",
  workspaceCopy: "Individual courses or organization portals.",
