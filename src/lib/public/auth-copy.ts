...
const englishAuthCopy: AuthCopy = {
  ...
  individualCopy: "Personal courses and practice.",
  ...
  organizationBenefits: "Simple personal access. Scoped organization portals.",
  organizationCode: "Organization code",
  organizationCopy: "School, academy, or cohort.",
  ...
  signupPanelCopy: "Choose personal learning or an organization portal.",
  ...
  teacher: "Teacher",
  teacherCopy: "Create, assign, and review work.",
  useIndividual: "Use as individual",
  welcomeBack: "Welcome back",
  workspaceTitle: "Enter your learning workspace.",
  workspaceCopy: "Choose personal access or an organization portal.",
