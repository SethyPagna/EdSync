...
function buildWorkflowSlides(labels: WorkflowLabels): WorkflowSlide[] {
  return [
  {
    ...
    headline: "One connected path.",
    subtitle: "Catalog, studio, AI, practice, and proof move together.",
  ...
  },
  {
    ...
    headline: "Browse first.",
    subtitle: "Start solo or enter an organization portal.",
    route: "/catalog",
    icon: Search,
  ...
  },
  {
    ...
    subtitle: "Draft outlines, slides, quizzes, and variants for review.",
    route: "/ai",
    icon: Wand2,
    accent: "text-edsync-emerald",
  ...
  },
  {
    ...
    subtitle: "Work, deadlines, discussion, and feedback stay connected.",
  ...
  },
  {
    ...
    subtitle: "Quizzes, flashcards, sprint, retry, and help stay focused.",
    route: "/practice",
    icon: Trophy,
  ...
  },
  {
    ...
    shortTitle: labels.grades,
    headline: "Progress becomes control.",
    subtitle: "Owners see portals, AI health, security, and audit trails.",
